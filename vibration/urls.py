...
from vibration.views import Initialization, EquipmentSet, begin, VibrationFunc, para_set, para_valid, simulate, Absorber
...
urlpatterns = [
    ...
    url(r'absorber/', Absorber.as_view(), name="absorber"),
